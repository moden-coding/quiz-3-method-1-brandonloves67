 ...
 * 
 * Note:
 * You will modify computeArea() over the course of this quiz. Completing task 2
 * may cause task 1
 * to not work any longer. That's OK! Similarly, completing task 3 might cause
 * task 2 to no longer work.
 * ##############################################################################################
 * TASK 1:
 * Modify computeArea() so it will find the area of a rectangle with length of 4
 * and height of 3.
 * Remember that the area of a rectangle is found by multiplying length by
 * width.
 * 
 ...
 * 2. Too large values (greater than 100) for length or height return a value of
 * -1
 * 
 * STOP HERE FOR: 'A'
 * ##############################################################################################
 ...
 * 1. It accepts a third parameter which is a String. This parameter will
 * describe the type of
 * object.
 * 2. If the String is "rect", calculate as you have before.
 * 3. If the String is "tri", calculate the area using the formula .5 * length *
 * width
 * 
 * The method should still return -1 for negative values and for values that are
 * too large.
 * STOP HERE FOR: 'A+'
 */
